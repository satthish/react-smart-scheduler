  ...
  return (
    ...
    >
      <div className="rss-header-nav">
        <button className="rss-btn rss-btn--icon" onClick={handlePrev} aria-label="Previous" title="Previous">
          ‹
        </button>
        <button className="rss-btn" onClick={handleToday} aria-label="Go to today">
          Today
        </button>
        <button className="rss-btn rss-btn--icon" onClick={handleNext} aria-label="Next" title="Next">
          ›
        </button>
      </div>
